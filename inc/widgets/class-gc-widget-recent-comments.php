 ...
 * @see WP_Widget
 */
class GC_Widget_Recent_Comments extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'gc-recent-comments', __( 'GC Recent Comments' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		if ( $subtitle ) {
			$output .= '<p class="widget-subtitle">' . $subtitle . '</p>';
		}
